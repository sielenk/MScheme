	...
	extends TestCase
{
	...
	throws Exception
	{
		checkReadWrite(ScmChar.create('a'));
		checkReadWrite(ScmChar.create('\n'));
		checkReadWrite(ScmChar.create(' '));
	}
	...
	throws Exception
	{
		...
		checkReadWrite(ListFactory.create(ScmChar.create('b'), ScmChar.create('\n')));
	}
	...
	throws Exception
	{
		...
		checkReadWrite(ScmVector.create(new Object[] { ScmChar.create('b'), ScmChar.create('\n') }));
	}
}
